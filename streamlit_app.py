...
from aqi_utils import categorize_aqi  # noqa: E402
from feature_engineering import SEASON_MAP  # noqa: E402
...
def main():
    ...
    if bundle is None:
        st.error(
            ...
            "Run `python src/train.py` then `python src/evaluate.py` first."
        )
        return
